<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editShoppingCart.aspx.cs" Inherits="Customer_editShopping" %>
...
<body>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="true" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="数量" HeaderText="原数量">
                <HeaderStyle Font-Bold="true" Font-Size="18px" Font-Names="隶书" ForeColor="Blue"/>
                <ItemStyle HorizontalAlign="Center"/>
            </asp:BoundField>
    ...
    <tr>
        <td style="text-align:center"><asp:Button ID="Button1" runat="server" Text="保存购物车" OnClick="Button1_Click" /> &nbsp&nbsp&nbsp
