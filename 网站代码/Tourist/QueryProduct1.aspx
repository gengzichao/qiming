<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryProduct1.aspx.cs" Inherits="Tourist_QueryProduct1" %>
...
<body>
    ...
    <tr>
        <td colspan="2"><asp:Button ID="Button1" runat="server" Text="退出查询" OnClick="Button1_Click" /></td>
    </tr>
