<%@ Page Language="C#" AutoEventWireup="true" CodeFile="disOrderform1.aspx.cs" Inherits="Manager_disOrderform1" %>
...
<body>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="true" AutoGenerateColumns="false"
       ...
       <Columns>
            ...
            <asp:CommandField ButtonType="Button" EditText="选择" ShowEditButton="true" HeaderText="查看订单">
                <HeaderStyle Font-Bold="true" Font-Size="18px" Font-Names="隶书" ForeColor="Blue"/>
                <ItemStyle HorizontalAlign="Center"/>
            </asp:CommandField>
        </Columns>
